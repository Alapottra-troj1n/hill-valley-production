        ...
        <div className='pb-20 pt-10 bg-white container mx-auto' >
            ...
            <div className='flex justify-center items-center gap-4 mt-20' >
                ...
                <div className='flex justify-center items-center gap-2' >
                    ...
                    <h2 className='font-semibold' >Let's talk on </h2> <a href='https://www.facebook.com/hvpweddings' target='_blank' rel="noreferrer"><BsFacebook className='text-2xl text-blue-500 hover:text-blue-700 transition-all' /></a>  <h2 className='font-semibold' >or simply call us on </h2> <a className='font-semibold underline' href="tel:+8801889759000">+8801889759000</a> <h2 className='font-semibold' >for bookings</h2>
                </div>
