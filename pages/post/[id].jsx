  ...
  if (isMobile) {
    postBg = (
      <div className="relative h-[80vh]">
        <Image
          src={data[0]["mobile cover"]}
          objectFit="cover"
          objectPosition="center"
          layout="fill"
        />
        <h2 className="text-2xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 whitespace-nowrap font-display text-center font-semibold">
          {data[0].title}
        </h2>
      </div>
    );
    ...
    postBg = (
      <div
        rel="preload"
        style={{ backgroundImage: `url(${data[0].coverphoto})` }}
        className={`flex justify-center items-center bg-no-repeat bg-cover bg-center lg:h-[80vh] h-[50vh] bg-fixed bg-slate-200`}
      >
        <h2 className="font-display text-center text-3xl lg:text-7xl font-semibold war">
          {data[0].title}
        </h2>
      </div>
    );
  ...
  return (
    <div className="text-white ">
      ...
      <div className="py-24 container mx-auto text-slate-500 font-normal font-type  lg:px-40  px-4">
        ...
        >
          <h2 className="leading-6 text-xs lg:text-sm lg:leading-7">
            {data[0]?.story ? data[0].story : ""}
          </h2>
